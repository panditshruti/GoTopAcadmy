...
import com.shrutipandit.gotopacademy.databinding.FragmentStanzaBinding
import com.shrutipandit.gotopacademy.db.NoticeItem

class StanzaFragment : Fragment(R.layout.fragment_stanza) {

        private lateinit var binding: FragmentStanzaBinding
